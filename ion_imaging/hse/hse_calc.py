...
fmasses.write("galidstr= %5.2f %5.2f %5.3f MDM= %5.3e Mstars=  %5.3e %5.3e MISMs= %5.3e %5.3e MCGM= %5.3e MCGM_sub= %5.3e %5.3e %5.3e %5.3e %5.3e\n"%(M200,ms,sfr,M_DM,M_stars,M_stars_30kpc,M_ISM,M_ISM_30kpc,M_CGM,M_lt104,M_104_105,M_105_106,M_106_107,M_gt107))
fmasses.close()
...
hse_spherical.calc_Euler_spherical(10**bin_edges_3D[0]*cmpermpc, bin_edges_3D[1], bin_edges_3D[2], Totmass_radial, P_hotfilter_3D, density_all_3D, vrad_all_3D*1e+05, vtheta_all_3D*1e+05, vphi_all_3D*1e+05, acc_all_3D, galidstr, "Hotfilter", M200, R200)
