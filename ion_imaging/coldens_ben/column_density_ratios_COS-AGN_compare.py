...
filename1 = coldens_basename1 + '.' + dir + '.l' + size + '.dat' 
filename2 = coldens_basename2 + '.' + dir + '.l' + size + '.dat' 
...
hcol1, ocol1, h1col1, c4col1, o6col1, o7col1, o8col1, mg2col1, dist1, n5col1, c2col1, c3col1, si2col1, si3col1, si4col1 = np.loadtxt(filename1, usecols=(2,3,4,5,6,7,8,9,10,14,15,16,17,18,19), unpack=True)

hcol2, ocol2, h1col2, c4col2, o6col2, o7col2, o8col2, mg2col2, dist2, n5col2, c2col2, c3col2, si2col2, si3col2, si4col2 = np.loadtxt(filename2, usecols=(2,3,4,5,6,7,8,9,10,14,15,16,17,18,19), unpack=True)
...
plot_ion_ratio_compare_contours(h1col1[indexes_radius1],n5col1[indexes_radius1]-h1col1[indexes_radius1],h1col2[indexes_radius2],n5col2[indexes_radius2]-h1col2[indexes_radius2],h1lo,h1hi,n5h1lo,n5h1hi,'log[$N_{\mathrm{HI}}$]','log[$N_{\mathrm{NV}}/N_{\mathrm{HI}}$]','h1_n5h1')
