...
result = coldens.main(coords, hsmooth, mass*hydrogen, center, 0.3, 0.3, 0.3, 400, 400, 58, 25,fig_name='test_hydrogen_z2.pdf',Vmin=17, Vmax=22)

result = coldens.main(coords, hsmooth, mass*carbon/12.0, center, 0.3, 0.3, 0.3, 400, 400, 58, 25,fig_name='test_carbon_z2.pdf',Vmin=13, Vmax=18)

result = coldens.main(coords, hsmooth, mass*oxygen/16.0, center, 0.3, 0.3, 0.3, 400, 400, 58, 25,fig_name='test_oxygen_z2.pdf',Vmin=13, Vmax=18)
