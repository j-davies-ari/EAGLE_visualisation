...
coords_shift = np.abs(coords - gal_coords)
coords_shift = np.where(coords_shift > 0.5*boxsize*aex/hubble_param, boxsize*aex/hubble_param - coords_shift, coords_shift)
