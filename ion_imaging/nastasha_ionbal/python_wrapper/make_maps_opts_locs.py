...
Helper file for make_maps: containts lists, directories, etc. used in calculations
"""
...
dir_iontab = '/hpcdata1/extboppe/serena/IonizationTables/HM01G+C/%s' 

dir_coolingtab = '/disks/eagle/BG_Tables/CoolingTables/'
c_interpfile = '/home/extboppe/pythonCode/nastasha_ionbal/interp2d/interp2d.so'
